...
public class AlarmSystemTest extends GenericTest {

	@Override
	protected TIOSTS setupProcessedModel() {
		Compiler.compile("./examples/AlarmSystem.srt", "BurglarAlarmSystem");
		return Compiler.getSpecification("BurglarAlarmSystem");
	}

	@Override
	protected TIOSTS setupModel() {
		return UtilTest.createAlarmSPEC();
	}
