...
public class ATMTest extends GenericTest {

	@Override
	protected TIOSTS setupProcessedModel() {
		Compiler.compile("./examples/ATM.srt", "WithdrawalTransation1");
		return Compiler.getSpecification("WithdrawalTransation1");
	}

	@Override
	protected TIOSTS setupModel() {
		return UtilTest.createAtmSPEC();
	}
